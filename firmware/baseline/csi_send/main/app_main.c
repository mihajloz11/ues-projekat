// pošiljalac je zasnovan na Espressif CSI get-started primjeru
// preko ESP-NOW šalje oko 100 paketa u sekundi da prijemnik ima stalan CSI saobraćaj
...
void app_main()
{
    // NVS se pokreće prvi jer ga WiFi koristi za svoje podatke
    ...
    // WiFi radi u STA modu na fiksnom kanalu
    wifi_init();

    // ESP-NOW peer je broadcast adresa, pa paketi idu svim uređajima na kanalu
    ...
    // beskonačna petlja šalje brojač, a pauza određuje frekvenciju
